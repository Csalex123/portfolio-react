...
function menu({ title, description, }) {
    ...
    return (
        <>
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-light fixed-top shadow" style={{ backgroundColor: "#fff", color: "black" }}>
                <div className="container-fluid mr-md-0 ml-md-0 mr-xl-5 ml-xl-5 mr-sm-0 ml-sm-0 ">
                    <div className="navbar-brand d-flex align-items-center" style={{ cursor: "pointer" }}>
                        ...
                        <h3 style={{ color: "#000435" }}>Alex Ricardo</h3>
                    </div>
