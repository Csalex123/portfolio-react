        ...
        <>
            ...
            <div className="about container">
                ...
                <div className="about__content row align-items-center mt-2 ">
                    ...
                    <section className="col-xs-12 col-md-12 col-lg-6">
                        <img className="img-fluid" src={Ilustracao} alt="Ilustração" />
                    </section>

                    <section className="about__information col-xs-12 col-md-12 col-lg-6">
                        ...
                        <h5 className="text-center mt-4"> Desenvolvedor Web</h5>
